                        ...
                        if cell is None:
                            ...
                            if ship is None:
                                ...
                                if ship.alignement != alignement_move:
                                    ...
                                    rotated_cases = joueur1.plateau.calculer_cases_pour_bateau(ship, anchor_case.ligne, anchor_case.colonne, alignement_move)
